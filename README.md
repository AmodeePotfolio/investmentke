    ...
    <main>
      <section class="grid" aria-label="Investment packages">
        ...
        <article class="card" id="charteredCard" data-key="chartered">
          <div>
            <div class="title">🏦 Chartered Loans</div>
        ...
        <article class="card" id="premiumCard" data-key="premium">
          <div>
            <div class="title">✨ Premium (Daily Yield)</div>
            <div class="desc">High-frequency daily returns for short-term investors.</div>

            <div class="expand" aria-hidden="true">
              <div class="plans">
                <div class="plan">1) Invest 500 → Earn 750 (daily)</div>
                <div class="plan">2) Invest 750 → Earn 1000 (daily)</div>
                <div class="plan">3) Invest 1000 → Earn 1400 (daily)</div>
              </div>
        ...
        <article class="card" id="standardCard" data-key="standard">
          <div>
            <div class="title">📈 Standard (Weekly Yield)</div>
            <div class="desc">Stable weekly returns for balanced investors.</div>

            <div class="expand" aria-hidden="true">
              <div class="plans">
                <div class="plan">1) Invest 1,000 → Earn 1,200 (weekly)</div>
                <div class="plan">2) Invest 2,000 → Earn 2,400 (weekly)</div>
                <div class="plan">3) Invest 5,000 → Earn 6,250 (weekly)</div>
              </div>
              <div style="display:flex; justify-content:flex-end;">
        ...
        <article class="card" id="corporateCard" data-key="corporate">
          <div>
            <div class="title">🏢 Corporate (Monthly Yield)</div>
            <div class="desc">Premium monthly returns for institutional and corporate clients.</div>

            <div class="expand" aria-hidden="true">
              <div class="plans">
                <div class="plan">1) Invest 10,000 → Earn 12,500 (monthly)</div>
                <div class="plan">2) Invest 25,000 → Earn 31,250 (monthly)</div>
                <div class="plan">3) Invest 50,000 → Earn 63,000 (monthly)</div>
              </div>
              <div style="display:flex; justify-content:flex-end;">
      ...
      <div>
        <div id="about">
          ...
          <div style="font-size:13px; color:rgba(255,255,255,0.8); margin-top:6px;">
            Chartered Investments — learn, grow, and thrive in the digital economy.
          </div>
        </div>
  ...
  <script>
    ...
    document.querySelectorAll('button[data-action="invest"]').forEach(btn=>{
      btn.addEventListener('click', (e)=>{
        ...
        // Open payment link in a new tab — you can add query params if you want to pass package info
